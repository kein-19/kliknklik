    ...
    <div class="row justify-content-center">
      <div class="col-lg-4">
        ...
        <ul class="list-group mb-4">
          ...
          <li class="list-group-item">KLIKNKLIK.COM</li>
          <li class="list-group-item">Ruko Bahan Bangunan, Blok F1 No 5-6. Jakarta Pusat 10730</li>
          <li class="list-group-item">(021) 26071436</li>
        </ul>
      </div>
